...
figure_directory <- file.path(wd, "Exports/Figures")
version_directory <- file.path(wd, "Exports/Versions/20240522")
...
version_directory <- file.path(wd,"Exports/Versions/20230522.1")  #used to be /20230522
