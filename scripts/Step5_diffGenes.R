...
# in topTable function above, set 'number=40000' to capture all genes.
  # In the future, set number = higher than the number of genes in the data (which
...
mySwitchList <- importRdata(
  ...
  isoformExonAnnoation = "raw_data/Homo_sapiens.GRCh38.111.chr_patch_hapl_scaff.gtf.gz",
  isoformNtFasta       = "raw_data/Homo_sapiens.GRCh38.cdna.all.fa",
  showProgress = TRUE)
