...
#archs4.human <- "../../ARCHS4/archs4_gene_human_v2.1.2.h5"
archs4.mouse <- "../../ARCHS4/archs4_gene_mouse_v2.1.2.h5"
...
keepers <- rowSums(archs4.cpm>1)>=2 #2 because we are working with duplicates
